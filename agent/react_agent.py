...
from agent.tools.middleware import report_prompt_switch, log_before_model, monitor_tool
...
class ReAct_Agent(object):
    ...
    def execute_stream(self, query: str):
        ...
        # 第三个参数context就是上下文runtime中的信息，就是我们做提示词切换的标记(告诉模型，当前是生成报告还是生成内容)(保证有这个字典，否则会报错)
